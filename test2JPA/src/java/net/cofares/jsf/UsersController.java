package net.cofares.jsf;

import net.cofares.entity.Users;
import net.cofares.jsf.util.JsfUtil;
import net.cofares.jsf.util.JsfUtil.PersistAction;
import net.cofares.bean.UsersFacade;
...
public class UsersController implements Serializable {
    ...
    @EJB
    private net.cofares.bean.UsersFacade ejbFacade;
